...
public class UpdateWBArea {
	...
	public static void main(String[] args) throws SeException,
		...
		String layerName = "sde.sde.wubaiarea"; // 五百分区图层名称
		String updateTable = "sde.sde.wushiarea";
		
		SeQuery queryResult = getQueryResult(layerName, cols, null);
		...
		while (row != null) {
			for (int i = 0; i < colDefs.length; i++) {
				...
				case SeColumnDefinition.TYPE_SHAPE:
					...
					SeQuery shapes = getContainsShape(updateTable, SHAPECOLUMN, shape); // 得到包含的shape
					System.out.println("updateResult : *******************");
					updateResult(updateTable, shapes, code, shapes.getNumColumns());
					break;
				default:
					break;
				}
	...
	private static SeQuery getQueryResult(String layerName, String[] cols,
			SeFilter[] filters) throws SeException {
